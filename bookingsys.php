		...
		<form action="bookingsys.php" method="post">
				...
				<div class="row">
					<div class="form1 text-center" align="center">
						...
						$sql="INSERT INTO bookingswebsite (FirstName, SecondName, Room, Nights) VALUES ('$FirstName', '$SecondName', '$Room', '$Nights')";

						//check if the query was completed, show error if not completed. add comment when completed
						if(!mysqli_query($con,$sql)){
						die ('Error: ' .mysqli_error($con));
						}
						else{
						echo "Booking completed. Thank you.";
						}
